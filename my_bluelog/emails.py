...
from my_bluelog.extensions import mail
...
def send_new_comment_email(post):
    post_url = url_for('blog.show_post', slug=post.slug, _external=True) + '#comments'
...
def send_new_reply_email(comment):
    post_url = url_for('blog.show_post', slug=comment.post.slug, _external=True) + '#comments'
